import { getCardProvider } from './cards.js';
...
export function spawnCard() {
    if (state.health <= 0)
        return; // Don't spawn cards if game is over
    if (!document.hidden) {
...
export function handleCorrectAnswer(answer) {
...
export function handleIncorrectCard(card) {
    state.health--;
    updateStats();
